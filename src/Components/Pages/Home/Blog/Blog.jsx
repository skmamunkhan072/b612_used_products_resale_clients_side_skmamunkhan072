  ...
  return (
    <section className="overflow-hidden text-gray-700 my-10">
      <div className="grid gap-5 grid-cols-1 md:grid-cols-2">
        <div className="lg:flex lg:flex-wrap rounded-lg bg-gray-600 p-4">
          <div className="w-full p-4 md:p-2">
            ...
            <p className="text-xl text-start text-gray-400 mt-2">
              ...
              manage them in the most effective way. To do it, remove state from
              both of them, move it to their closest common parent, and then
              pass it down to them via props. This is known as “lifting state up
            </p>
          </div>
        </div>
